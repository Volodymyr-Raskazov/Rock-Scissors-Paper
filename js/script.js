...
/**
 * 1. Зробити інтерфейс за допомогою HTML&CSS. - done
 * 	1.1. Зробити блок з рахунком. - done
 * 	1.2. Зробити 3 кнопки з фігурами "камінь-ножиці-бумага". done
 * 	1.3. зробити кнопку "правила". - done
 * 		1.3.1. Кнопка "правила" відкриває модальне вікно. - done
 * 		1.3.2. Зробити модальне вікно. - done
 * 	1.4. Зробити кнопку скидання рахунку. 
 * 
 * 2. При кліку по одній з кнопок "камінь-ножиці-бумага" скривати не обрані.
 * 	2.1. Запускати таймер 3 секунди.
 * 	2.2. Після таймеру показувати, що обрав супротивник.
 * 	2.3. Випадковий вибір фігури супротивником.
 * 	2.4. Порівняння нашого вибору та вибору супротивника.
 * 		2.4.1. Якщо вибір однаковий, вивести повідомлення "нічия".
 * 		2.4.2. Якшо наш вибір б'є вибір супротивника +1 очко.
 * 		2.4.3. Якщо вибір супротивника б'є наш - -1 очко.
*/
/** ------------------------
